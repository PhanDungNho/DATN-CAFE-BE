    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors().and().csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize
                		.requestMatchers("/api/v1/login", "/api/v1/products/images/**").permitAll()
//                		.requestMatchers("/api/v1/cart/**","/api/v1/categories/**","/api/v1/products/**","/api/v1/sizes/**","/api/v1/orders/**","/api/v1/toppings/**").hasAnyRole("ADMIN","STAFF")
